// ==UserScript==
// @name         Pokémon Showdown Battle Crash Patch
...
if (new Date().getTime() < 1444907396326) { // Set expiration to 1 day from publish

	var BattleEffects = unsafeWindow.BattleEffects = {
		wisp: {
			url: 'fx/wisp.png',
			w: 100, h: 100
		},
	...
	var BattleBackdropsThree = unsafeWindow.BattleBackdropsThree = [
		'bg-gen3.png',
		'bg-gen3-cave.png',
		'bg-gen3-ocean.png',
		'bg-gen3-sand.png',
	...
	var BattleBackdropsFour = unsafeWindow.BattleBackdropsFour = [
		'bg-gen4.png',
		'bg-gen4-cave.png',
		'bg-gen4-snow.png',
		'bg-gen4-indoors.png',
	...
	var BattleBackdrops = unsafeWindow.BattleBackdrops = [
		'bg-beach.png',
		'bg-beachshore.png',
		'bg-desert.png',
		'bg-meadow.png',
	...
	var BattleStats = unsafeWindow.BattleStats = {
	...
	var BattleItems = unsafeWindow.BattleItems = {
	};
	var BattleOtherAnims = unsafeWindow.BattleOtherAnims = {
		attack: {
	...
	var BattleStatusAnims = unsafeWindow.BattleStatusAnims = {
		brn: {
			anim: function(battle, args) {
				var attacker = args[0];
	...
	var BattleMoveAnims = unsafeWindow.BattleMoveAnims = {
		taunt: {
